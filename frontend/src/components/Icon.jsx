...
const PATHS = {
  ...
  heart: (
    <path
      d="M12 20.5s-7.5-4.6-9.8-9.1C.6 8 2 4.7 5.2 3.7 7.6 3 9.8 4 12 6.2 14.2 4 16.4 3 18.8 3.7c3.2 1 4.6 4.3 3 7.7-2.3 4.5-9.8 9.1-9.8 9.1z"
      {...stroke}
    />
  ),
  lightbulb: (
    <>
      <path d="M9 18.5h6M10 21.5h4" {...stroke} />
      <path d="M12 2.5a6.5 6.5 0 00-3.8 11.8c.6.45.8 1 .8 1.7v.3h6v-.3c0-.7.2-1.25.8-1.7A6.5 6.5 0 0012 2.5z" {...stroke} />
    </>
  ),
  shield: (
    <path
      d="M12 2.5l7.5 3v5.3c0 4.9-3.2 8.9-7.5 10.7-4.3-1.8-7.5-5.8-7.5-10.7V5.5l7.5-3z"
      {...stroke}
    />
  ),
  users: (
    <>
      ...
      <path d="M2.5 19.5c0-3.3 2.7-5.5 6-5.5s6 2.2 6 5.5" {...stroke} />
      <path d="M15.5 5.3a3 3 0 010 5.9" {...stroke} />
      <path d="M15.5 14c2.7.3 4.5 2.3 5 5.5" {...stroke} />
    </>
  ),
